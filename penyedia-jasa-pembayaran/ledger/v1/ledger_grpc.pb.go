...
func (c *ledgerServiceClient) CreateJournalEntry(ctx context.Context, in *CreateJournalEntryRequest, opts ...grpc.CallOption) (*CreateJournalEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.v1.LedgerService/CreateJournalEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ledgerServiceClient) InitializeAccount(ctx context.Context, in *InitializeAccountRequest, opts ...grpc.CallOption) (*InitializeAccountResponse, error) {
	out := new(InitializeAccountResponse)
	err := c.cc.Invoke(ctx, "/ledger.v1.LedgerService/InitializeAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLedgerServiceServer) InitializeAccount(context.Context, *InitializeAccountRequest) (*InitializeAccountResponse, error) {
...
func _LedgerService_CreateJournalEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.v1.LedgerService/CreateJournalEntry",
	}
...
func _LedgerService_InitializeAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.v1.LedgerService/InitializeAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
